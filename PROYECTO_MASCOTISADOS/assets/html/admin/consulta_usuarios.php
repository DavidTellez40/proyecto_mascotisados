...
$registros = mysqli_query($mascotisados, "select id_usuario, funadmin, primer_nombre, apellido_paterno, apellido_materno, email, passaword,nickname
from usuarios") or
...
echo "password:" . $reg['passaword'] . "<br>";
